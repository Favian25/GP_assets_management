...
const emptyForm = {
  ...
  jumlahUnit: "", hargaAset: "", tanggalPembelian: "",
};
...
export default function AksesorisPage() {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {isEdit && (
            <div>
              ...
              <div className="rounded-lg bg-slate-50 border border-slate-200 px-3 py-2.5 text-sm font-mono font-bold text-primary">{data.kodeAksesoris}</div>
            </div>
          )}
  ...
  if (loading) {
    return (
      <div>
        <div className="mb-6"><h1 className="text-2xl font-bold text-slate-800">Daftar Aksesoris</h1><p className="text-sm text-slate-500">Kelola data aksesoris Galeria Production</p></div>
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">Kelola data aksesoris Galeria Production</p>
      </div>
          ...
          <table className="w-full text-left text-sm table-fixed">
            <thead>
              <tr className="border-t border-t-slate-300 border-b border-b-slate-300">
                <th className="w-[140px] px-5 py-3 font-bold text-slate-700"><button onClick={() => handleSort("kodeAksesoris")} className="cursor-pointer flex items-center uppercase tracking-wider">Kode <SortIcon columnKey="kodeAksesoris" sortConfig={sortConfig} /></button></th>
                <th className="w-[80px] px-3 py-3 font-bold text-slate-700 text-center uppercase tracking-wider">Gambar</th>
                <th className="w-[190px] px-5 py-3 font-bold text-slate-700"><button onClick={() => handleSort("namaAksesoris")} className="cursor-pointer flex items-center uppercase tracking-wider">Nama <SortIcon columnKey="namaAksesoris" sortConfig={sortConfig} /></button></th>
                <th className="w-[120px] px-5 py-3 font-bold text-slate-700"><button onClick={() => handleSort("jumlahUnit")} className="cursor-pointer flex items-center uppercase tracking-wider">Jumlah <SortIcon columnKey="jumlahUnit" sortConfig={sortConfig} /></button></th>
                ...
                <th className="w-[130px] px-5 py-3 font-bold text-slate-700"><button onClick={() => handleSort("merek")} className="cursor-pointer flex items-center uppercase tracking-wider">Merek <SortIcon columnKey="merek" sortConfig={sortConfig} /></button></th>
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                <tr key={item.id} className={`border-b border-slate-100 transition-colors ${index % 2 === 0 ? "bg-slate-100" : "bg-white"}`}>
                  <td className="w-[140px] px-5 py-3 font-mono text-xs font-bold text-primary hover:underline cursor-pointer truncate" onClick={() => setShowDetail(item)}>{item.kodeAksesoris}</td>
                  ...
                  <td className="w-[190px] px-5 py-3 text-slate-600 hover:text-primary cursor-pointer truncate" onClick={() => setShowDetail(item)}>{item.namaAksesoris}</td>
                  <td className="w-[120px] px-5 py-3">
                    <div className="flex flex-col">
                      <span className="text-[13.5px] font-semibold text-emerald-600">{item.jumlahUnit ?? "-"} Tersisa</span>
                      <span className="text-slate-600">dari Total {item.jumlahTotal ?? item.jumlahUnit ?? "-"}</span>
                    </div>
                  </td>
              ...
              {assets.length === 0 && (<tr><td colSpan={8} className="px-5 py-10 text-center text-slate-400">Tidak ada data aksesoris ditemukan.</td></tr>)}
            </tbody>
          </table>
        </div>
            ...
            <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/40 p-4 transition-opacity animate-in fade-in duration-300" onClick={() => setShowDetail(null)}>
              <div className="max-h-[90vh] w-full max-w-lg flex flex-col rounded-2xl bg-white shadow-xl border-t-4 border-t-blue-500 animate-modal-in" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-6 space-y-5 overflow-y-auto custom-scrollbar flex-1">
                  ...
                  <div>
                    <h4 className="mb-3 text-sm font-bold text-slate-800">Informasi Aksesoris</h4>
                    <div className="space-y-2.5">
                      {[
                        ...
                        ["Harga", formatRupiah(showDetail.hargaAset)], 
                  ...
                  <div>
                    <h4 className="mb-3 text-sm font-bold text-slate-800">Lokasi & Kondisi</h4>
                    <div className="space-y-2.5">
