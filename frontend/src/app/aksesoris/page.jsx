            ...
            <tbody>
              {paginatedData.map((item, index) => (
                <tr key={item.id} className={`border-b border-slate-100 transition-colors ${index % 2 === 0 ? "bg-slate-100" : "bg-white"}`}>
                  <td className="w-[140px] px-5 py-3 font-mono text-xs font-semibold text-slate-700 hover:text-primary cursor-pointer truncate" onClick={() => setShowDetail(item)}>{item.kodeAksesoris}</td>
