...
import { Search, FileText, Download, Filter, Package, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, ChevronUp, ChevronDown, RotateCcw, MapPin, Tag, Printer } from "lucide-react";
...
export default function AsetReportPage() {
  ...
  const getColumns = () => [
    ...
    { header: "Lokasi", dataKey: "lokasiAset" }
  ];
      ...
      <div className="p-5 flex flex-col gap-4 bg-white border-b border-slate-300">
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="relative w-full lg:flex-1">
            ...
            <input
              type="text"
              placeholder="Cari nama, kode, atau model aset..."
              value={search}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:flex lg:flex-nowrap gap-3 w-full lg:w-auto">
            ...
            <div className="relative w-full sm:w-auto sm:flex-1 lg:flex-none">
              ...
              >
                ...
                {getUniqueValues('lokasiAset').map(l => <option key={l} value={l}>{l}</option>)}
              </select>
            </div>
            <div className="relative w-full sm:w-auto sm:flex-1 lg:flex-none">
              <Filter className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
